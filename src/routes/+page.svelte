<script>
  import { setContext } from "https://demos.cloud.gooddata.com/components/ecommerce-parent-dev.js";
  import factory, {
    TigerTokenAuthProvider,
  } from "https://demos.cloud.gooddata.com/components/tigerBackend.js";
